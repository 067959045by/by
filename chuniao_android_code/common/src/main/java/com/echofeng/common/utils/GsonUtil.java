...
public class GsonUtil {
     ...
     * @return
     */
    public static <T> List<T> GsonToList(JsonElement jsonElement, Class<T> cls) {
        List<T> list = new ArrayList<T>();
    ...
    /*public static <T> ArrayList<T> GsonToList(String jsonString, Class<T> cls) {
