...
public class Utils {
    ...
    public static RequestBody createFile(String name) {
        ...
        return RequestBody.create(name,okhttp3.MediaType.parse("multipart/form-data; charset=utf-8"));
    }
    ...
    public static RequestBody createFile(File file) {
        ...
        return RequestBody.create(file,okhttp3.MediaType.parse("multipart/form-data; charset=utf-8"));
    }
    ...
    public static RequestBody createImage(File file) {
        checkNotNull(file, "file not null!");
        return RequestBody.create(file,okhttp3.MediaType.parse("image/jpg; charset=utf-8"));
    }
